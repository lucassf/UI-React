...
import { Breadcrumb, Button, Row, Form, Col } from 'react-bootstrap';
            ...
            <div className="container">
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-md-9">
                        <Form className="was-validated" onSubmit={this.handleSubmit} noValidate>
                            <Form.Group as={Row}>
                            ...
                            <Form.Group as={Row}>
                                ...
                                <Col md={10}>
                                    <Form.Control type="tel" id="telnum" name="telnum"
                            ...
                            <Form.Group as={Row}>
                                <Col md={{ size: 6, offset: 2 }}>
                                    <Form.Check>
                                        <Form.Check.Input type="checkbox" checked={this.state.agree}
                                            onChange={this.handleInputChange} name="agree" />
                                        <Form.Check.Label>
                                ...
                                <Col md={{ size: 3, offset: 1 }}>
                                    <Form.Control as="select" name="contactType" value={this.state.contactType} custom onChange={this.handleInputChange}>
                                        <option>Tel.</option>
                                        <option>Email</option>
                                    </Form.Control>
                                </Col>
                            ...
                            <Form.Group as={Row}>
                                ...
                                <Col md={10}>
                                    <Form.Control as="textarea" id="message" name="message" rows="12"
